# -*- coding: utf-8 -*-
#
# pytest-ansible-playbook documentation build configuration file, created by
...
project = u'pytest-ansible-playbook'
copyright = u'2015, Martin Bukatovič'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-ansible-playbook Documentation',
     [author], 1)
]
